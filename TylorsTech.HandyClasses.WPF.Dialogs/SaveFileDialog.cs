...
using TylorsTech.HandyClasses.WPF.Dialogs.Interop;
...
namespace TylorsTech.HandyClasses.WPF.Dialogs
{
    ...
    /// </para>
    /// <para>
    ///   This class precisely duplicates the public interface of <see cref="Microsoft.Win32.SaveFileDialog"/> so you can just replace
    ///   any instances of <see cref="Microsoft.Win32.SaveFileDialog"/> with the <see cref="SaveFileDialog"/> without any further changes
    ///   to your code.
    /// </para>
    /// </remarks>
    ...
    public sealed class SaveFileDialog : FileDialog
    {
        ...
        public SaveFileDialog()
        {
            if (!IsVistaFileDialogSupported)
                DownlevelDialog = new Microsoft.Win32.SaveFileDialog();
        }
        ...
        public bool CreatePrompt
        {
            get
            {
                if (DownlevelDialog != null)
                    return ((Microsoft.Win32.SaveFileDialog)DownlevelDialog).CreatePrompt;
                return GetOption(NativeMethods.FOS.FOS_CREATEPROMPT);
            }
            set
            {
                if (DownlevelDialog != null)
                    ((Microsoft.Win32.SaveFileDialog)DownlevelDialog).CreatePrompt = value;
                else
        ...
        public bool OverwritePrompt
        {
            ...
            {
                if (DownlevelDialog != null)
                    return ((Microsoft.Win32.SaveFileDialog)DownlevelDialog).OverwritePrompt;
                return GetOption(NativeMethods.FOS.FOS_OVERWRITEPROMPT);
            }
            set
            {
                if (DownlevelDialog != null)
                    ((Microsoft.Win32.SaveFileDialog)DownlevelDialog).OverwritePrompt = value;
                else
        ...
        {
            if (DownlevelDialog != null)
                return ((Microsoft.Win32.SaveFileDialog)DownlevelDialog).OpenFile();
            else
            {
        ...
        internal override TylorsTech.HandyClasses.WPF.Dialogs.Interop.IFileDialog CreateFileDialog()
        {
            return new TylorsTech.HandyClasses.WPF.Dialogs.Interop.NativeFileSaveDialog();
        }
