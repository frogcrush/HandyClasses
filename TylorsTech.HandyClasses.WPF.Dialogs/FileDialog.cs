...
namespace TylorsTech.HandyClasses.WPF.Dialogs
{
    ...
    public abstract class FileDialog
    {
        ...
        private Microsoft.Win32.FileDialog _downlevelDialog;
        ...
        /// <summary>
        /// Creates a new instance of <see cref="FileDialog" /> class.
        /// </summary>
        ...
        /// </para>
        /// <para>
        ///   If this property returns <see langword="false" />, the <see cref="FileDialog"/> class (and
            ...
            set
            {
                ...
                else
                {
                    if (value != _filter)
                    {
                        ...
                        {
                            var filterElements = value.Split(new char[] { '|' });
        ...
        /// </summary>
        /// <value>
        /// The regular <see cref="Microsoft.Win32.FileDialog"/> that is used when the Vista-style file dialog
        /// is not supported.
        /// </value>
        /// <remarks>
        /// This property is set by classes that derive from <see cref="FileDialog"/>.
        /// </remarks>
        [Browsable(false)]
        protected Microsoft.Win32.FileDialog DownlevelDialog
        {
            get
            {
        ...
        /// </summary>
        /// <returns>If the user clicks the OK button of the dialog that is displayed (e.g. <see cref="OpenFileDialog" />, <see cref="SaveFileDialog" />), <see langword="true" /> is returned; otherwise, <see langword="false" />.</returns>
        ...
        internal abstract TylorsTech.HandyClasses.WPF.Dialogs.Interop.IFileDialog CreateFileDialog();
